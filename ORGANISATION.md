# Organisation de l'alliance Waow / Organization of the Waow alliance
...
_This document describes the organization of the Waow alliance in the Last War game._
...
_The leader makes important decisions for the alliance, especially in terms of diplomacy._

- _The leader validates the content of this document, as well as future modifications._
- _The leader defines the objectives of the alliance and the strategy to achieve them._
- _The leader decides with which alliances to enter into a non-aggression pact, and with which alliances we are in conflict._

_The leader can be replaced by unanimous decision of all officers (R4). In this case, the leader resigns and an election is organized by the R4._
_The leader can resign of his own free will. In this case, an election is organized by the R4._

_All members R4, R3, R2 can participate in this election._

### Officiers (R4) / Officers (R4)
...
_The officers are appointed by the leader. If they do not give satisfaction, they can be replaced._

_The officers are essential members of the alliance. They undertake to participate regularly in the life of the alliance, to respect each other's perimeters and the leader's decisions._

_Four officers R4 are appointed at a minimum._

_We recommend not to appoint more than 6 R4 in total, in order to avoid dilution of responsibilities and too long consultations._

_All members of the alliance of level R3 can apply to become R4. No power level is required. They will have to prove their motivation and the regularity of their commitment._
...
_The recruiter is in charge of individual recruitments._
...
_The muse is in charge of the day-to-day management of the alliance._

_She advises the leader and reports to him the decisions to be made._

_The muse is in charge of strategic diplomatic relations: (peaceful) relations with the most powerful alliances, agreements with smaller alliances._

_The muse maintains this document from the leader's decisions._
...
_The butler is in charge of the organization of events._

_He defines when the events take place and how the players participate in them._

_The butler can propose that another member be appointed to assist him._

#### Autres officiers

D'autres officiers peuvent être nommés par le leader pour l'assister à sa demande.

_Other officers may be appointed by the leader to assist him at his request._

### Sous-Officiers (R3) / Non-commissioned officers (R3)
...
Les R3 peuvent être nommés par les R4 ou par le leader.

_The R3 are in charge of the operational level of the life of the alliance:_

- _answer questions from other members (advice, game operation, etc)_
- _spread good humor and collaboration_
- _coordinate the R2 during military operations, under the directives of the warlord._
- _propose to the R4 evolutions of organization or operations._

_The R3 can be appointed by the R4 or by the leader._

### Autres membres (R2) / Other members (R2)

Pas de responsabilités particulières. Les R2 se conforment aux instructions des membres de plus haut rang.

_No particular responsibilities. The R2 conform to the instructions of the higher-ranking members._

### Sur la piste d'envol (R1) / On the runway (R1)

Les membres sont placés en R1 avant d'être éjectés de l'alliance (pour inactivité, indiscipline, déloyauté, etc).

_Members are placed in R1 before being ejected from the alliance (for inactivity, indiscipline, disloyalty, etc)._

## Entrée et sortie de l'alliance / Entry and exit from the alliance
...
- _Members are free to leave the alliance if they wish. If so, they will not be held against them and no punitive action will be taken for this reason._
- _A member of the alliance can be ejected by the leader in case of serious breaches (disloyalty, illegal actions, insults, etc)_
- _Inactive members who have informed one of the R4 in advance retain their rank for the planned duration of their absence and are not ejected._
- _Inactive members who have not informed are placed in R1 after 5 consecutive days of inactivity._
- _Members placed in R1 can be ejected by one of the R4 without notice._

### Recrutements individuels / Individual recruitments
...
_The recruiter organizes individual recruitments and validates them one by one (he can of course rely on the opinion of the other officers if necessary)._

_He can rely on the entire alliance for initial contact._

_The recruiter is encouraged to write a recruitment strategy that will be transmitted to all members for implementation._

#### Conditions pour les recrutements individuels / Conditions for individual recruitments
...
- _Language: French preferred, English otherwise._
- _Minimum base level:_ 15
- _Minimum power: 7M_
- _Commitment to respect the rules of this document._

### Fusion d'alliances dans Waow / Alliance mergers into Waow
...
_The leader is directly responsible for contacting the leaders of other alliances to propose a merger with Waow. He can delegate this responsibility if he wishes._

_The leader validates the mergers himself if necessary. He cannot delegate this responsibility._

## Vie commune de l'alliance / Common life of the alliance
...
_Discussions in the alliance chat (in the game) or in #la-team-wav (discord) are free. Discussions do not need to be in direct relation with Last War._

_However, any expression of xenophobia, racism, sexism, or falling under French law will result in the immediate exclusion of the player. In the most serious cases, the player's name will be communicated to other alliances as well as to the game publisher._

_Members are free to contact players from other alliances by private message. But they must not harm the interests of the alliance in doing so. Courtesy and benevolence are required._

_Members are free to express themselves on the General, French and English channels with the same reservations._
...
_When one of our members is attacked by a player from another alliance, several cases arise:_

- _When the attacker is part of an alliance with which we have a pact, the attacked player reports the problem to the muse, or in her absence to the leader._
- _When the attacker is part of another alliance, immediate retaliation is allowed, but only and only against the attacker. The warlord alone can decide to extend the retaliation to all players of the attacking alliance._
- _Prudence and wisdom: do not do nonsense. We do not retaliate against a player who is able to reduce us all to dust._
